...
X4EasyInputSetDVILinkState, (
   ULONG_PTR hDevice,
   X4DVILINKOVERRIDE linkoverride ) )


API ( X4ERROR, X4API,
X4EasyInputGetEqualisation, (
   HX4DEVICE hDevice,
   PX4EQUALISATION pValue ) )


API ( X4ERROR, X4API,
X4EasyInputSetEqualisation, (
   HX4DEVICE hDevice,
   X4EQUALISATION value ) )
...
API ( X4ERROR, X4API,
X4EasyOutputGetNoSignalBehaviour, (
   HX4DEVICE hDevice,
   X4MONITORSTATE * pMonitorState ) )

API ( X4ERROR, X4API,
X4EasyOutputSetNoSignalBehaviour, (
   HX4DEVICE hDevice,
   X4MONITORSTATE MonitorState ) )